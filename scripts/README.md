...
**Что делает:**
1. Запрашивает название модели через input()
2. Отправляет тестовый запрос к модели через OpenRouter API
3. Выводит ответ модели при успехе или описание ошибки при неудаче
